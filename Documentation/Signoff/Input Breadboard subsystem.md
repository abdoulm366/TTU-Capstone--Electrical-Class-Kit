...
| Precision    | The board must be able to detect differences of at least 2 times the values (100 ohms versus 200 ohms) for any electrical component and must be accurate to within 10 percent of the component’s true value                         | Conceptual Design
...
[<img src="media/image1.png" style="width:3.80294in;height:5.55303in" alt="A screenshot of a computer Description automatically generated" />
](https://github.com/abdoulm366/TTU-Capstone--Electrical-Class-Kit/blob/aafc6cea78637835ef013e1436ee6886f6a7d714/Documentation/Signoff/media/Picture1.png)

Figure 1: Blocks

[<img src="media/image2.png" style="width:6.5in;height:3.25486in" alt="A computer screen shot of a circuit board Description automatically generated" />
](https://github.com/abdoulm366/TTU-Capstone--Electrical-Class-Kit/blob/aafc6cea78637835ef013e1436ee6886f6a7d714/Documentation/Signoff/media/Picture2.png)

Figure 2: Sensor Circuit

The schematic is divided up into two separate pieces. The first piece (Figure 1) is comprised of all the blocks the user will be able to insert into the sensor circuit (Figure 2). These values, as will be shown in the analysis, were chosen carefully so that there was a wide range of values to choose from as well as enough separation between each value so that computation would yield results that vary enough to be accurately measured. The titles of each block describe what is contained inside. The gold pieces in both the blocks and the sensor circuit represent contacts to allow the flow of current between the blocks and the sensor circuit when they are connected.
Once a block is placed in the appropriate slot (left to right = Resistor, Capacitor, and Diode), then the reference circuit built into the sensor is completed, and that voltage is picked up and transmitted to one of the Uno’s analog input pins. Once the MCU receives this data, it will make adequate adjustments to other various parts of the project depending on what value was read in.

## Analysis:

The analysis for this subsystem is straightforward. Simple voltage division equations can be used to determine the reading of the output voltage. This equation, in its general form reads, $V\_{\\text{out}} = V\_{s}(\\frac{R\_{\\text{block}}}{{R\_{\\text{reference}} + R}\_{\\text{block}}})$.. Doing all of the substitutions with the appropriate values yields the following results:

| *V*<sub>*S*</sub> (V) | *R*<sub>block</sub> (Ω) | *R*<sub>reference</sub> (Ω) | *V*<sub>out</sub> (V) |
|-----------------------|-------------------------|-----------------------------|-----------------------|
| 3.3                   | 10 ± 0.5                | 1000 ± 50                   | 0.03 ± 0.0021         |
| 3.3                   | 1000 ± 50               | 1000 ± 50                   | 1.65 ± 0.12           |
| 3.3                   | 100000 ± 5000           | 1000 ± 50                   | 3.27 ± 0.23           |
| 3.3                   | 10 ± 0.5                | 1000 ± 50                   | 0.03 ± 0.0021         |
| 3.3                   | 2000 ± 100              | 1000 ± 50                   | 2.20 ± 0.15           |
| 3.3                   | 500 ± 25                | 1000 ± 50                   | 1.10 ± 0.077          |

The resulting output voltages are calculated using gold-band resistors which have a tolerance of 5% of their indicated resistance value. Aside from one value, there is far from any overlap, and that instance was intentional, as it was put there in order to demonstrate parallel and series connections of resistors more thoroughly.
...
[<img src="media/image3.jpeg" style="width:6.5in;height:3.52083in" />](https://github.com/abdoulm366/TTU-Capstone--Electrical-Class-Kit/blob/aafc6cea78637835ef013e1436ee6886f6a7d714/Documentation/Signoff/media/Picture3.jpg)

Figure 3: 0.1 μF circuit

[<img src="media/image4.jpeg" style="width:6.5in;height:3.52083in" />
](https://github.com/abdoulm366/TTU-Capstone--Electrical-Class-Kit/blob/aafc6cea78637835ef013e1436ee6886f6a7d714/Documentation/Signoff/media/Picture4.jpg)

Figure 4: 1 μF circuit

[<img src="media/image5.jpeg" style="width:6.5in;height:3.52083in" />
](https://github.com/abdoulm366/TTU-Capstone--Electrical-Class-Kit/blob/aafc6cea78637835ef013e1436ee6886f6a7d714/Documentation/Signoff/media/Picture5.jpg)

Figure 5: 10 μF circuit

[<img src="media/image6.jpeg" style="width:6.5in;height:3.52083in" />
](https://github.com/abdoulm366/TTU-Capstone--Electrical-Class-Kit/blob/aafc6cea78637835ef013e1436ee6886f6a7d714/Documentation/Signoff/media/Picture6.jpg)

Figure 6: 2 μF circuit

[<img src="media/image7.jpeg" style="width:6.5in;height:3.52083in" />
](https://github.com/abdoulm366/TTU-Capstone--Electrical-Class-Kit/blob/aafc6cea78637835ef013e1436ee6886f6a7d714/Documentation/Signoff/media/Picture7.jpg)

Figure 7: 0.5 μF circuit

[<img src="media/image8.jpeg" style="width:6.5in;height:3.52083in" />
](https://github.com/abdoulm366/TTU-Capstone--Electrical-Class-Kit/blob/aafc6cea78637835ef013e1436ee6886f6a7d714/Documentation/Signoff/media/Picture8.jpg)
...
As can be seen above in the table and the pictures, the time never exceeds 1.2 seconds, so the constraint of working within 2 seconds is easily met. The times are also different enough that there’s no chance of mistaking one value for another.
...
| Breadboard      | 1         | https://shorturl.at/ctP26 | $ 11.99  |
